...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "dinil-ops-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/dinil_org"
  #   chef.validation_client_name = "dinil_org-validator"
  #   chef.validation_key_path = ".chef/dinil_org-validator.pem"
  # end
end
